...
![CI](https://github.com/phoodul/secretbank/actions/workflows/ci.yml/badge.svg)

## About

Secretbank is an open-core desktop and mobile application that goes beyond simple secret storage.
It maps how API keys relate to your projects, deployments, and URLs — so you always know the
blast radius before you rotate or revoke a key. When a provider reports a breach, Secretbank
...
- **CLI + MCP** — `Secretbank run -- cmd` (Doppler-style env injection from your dependency graph) and a stdio MCP server for Claude / Cursor / Copilot
...
User guide: **[secretbank.app/guide.html](https://secretbank.app/guide.html)** (English / 한국어 / 简体中文 — print to PDF in-browser) · raw markdown: [`USER_GUIDE.en.md`](./docs/USER_GUIDE.en.md) · [`USER_GUIDE.ko.md`](./docs/USER_GUIDE.ko.md) · [`USER_GUIDE.zh.md`](./docs/USER_GUIDE.zh.md)
...
| `/ee/`     | **Secretbank Enterprise License v1.0** ([ee/LICENSE](./ee/LICENSE)) | Cloudflare Workers relay, premium connectors, auto rotation, sync backend.       |
...
either an active subscription to the official Secretbank hosted service or a written enterprise
license agreement.
