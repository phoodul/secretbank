...
class CredentialsPanel(private val project: Project) : JPanel(BorderLayout()) {
    ...
    private val listModel = DefaultListModel<SecretbankService.CredentialMeta>()
    private val list = JBList(listModel)
    private val statusLabel = JBLabel(" ")
    private val searchField = JBTextField().apply {
        emptyText.text = "Filter by issuer / name…"
    }
    private var allCredentials: List<SecretbankService.CredentialMeta> = emptyList()
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            ...
            ApplicationManager.getApplication().invokeLater {
                ...
                statusLabel.text = if (creds.isEmpty()) {
                    "No credentials. Is the Secretbank CLI on your PATH?"
                } else {
    ...
    private class CredentialRenderer : DefaultListCellRenderer() {
        override fun getListCellRendererComponent(
            ...
            if (value is SecretbankService.CredentialMeta) {
