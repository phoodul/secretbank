...
| Dependabot-postcss | Dependabot 3 moderate 해소 — postcss-rem-to-pixel (2017 마지막 release, postcss 5.x peer) → postcss-rem-to-responsive-pixel@^7.0.4 (postcss 8 peer, 2026-04 active maintained, TypeScript 재작성) 교체. extension/postcss.config.cjs 옵션 동일 (rootValue=16, propList=['*'], default transformUnit='px'). 알림 #24 GHSA-566m-qj78-rww5 + #25 GHSA-7fh5-64p2-3v2j + #26 GHSA-qx2v-qp2m-jg93 모두 자동 close 예정. dedupe: 3 → 2 versions (8.5.10/8.5.14), 13 패키지 제거. 검증: extension build (chrome+firefox) 성공 + 650 PASS + typecheck 0 + web-ext 34 PASS, 회귀 0 | 2026-05-10 | pending |
