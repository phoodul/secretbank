...
| M9  | Sync Infrastructure             | T087~T096   | 10        | 🔄 진입 (Phase A + B (incl. B-4) + C + **D (D-1+D-2)** 종료 — D-3/E/F/G 남음) |
