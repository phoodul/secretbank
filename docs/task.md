...
| M9  | Sync Infrastructure             | T087~T096   | 10        | 🔄 진입 (Phase A + B + C + D + E + F + G-pair-1/2/3 + G-pair-4a + **G-pair-4b (joiner UI)** 종료 — G 잔여 (G-pair-2.5 + G-pair-4c deep-link auto-route + G-conflict + G-offline + G-entitlement)) |
