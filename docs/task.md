...
- **Status**: 🔄 31/53 완료 — Phase A 7/7 ✅ + Phase B 10/10 ✅ + Phase C 8/8 ✅ + **Phase D 6/6 ✅** (D-1 hook → D-2 bridge → D-3 banner → D-4 handler → D-5 actor+issuer → D-6 IPC+dialog) + GATE 1/2/2-bis 승인. **Phase D 클로즈 (save dialog 풀체인)**. 다음 = Phase E (generator inline + Site Logo + popup credential 카드, **1P 동등 dogfooding 시점**).
