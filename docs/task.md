...
| M9  | Sync Infrastructure             | T087~T096   | 10        | 🔄 진입 (Phase A + B + C + D + E + F + G-pair-1 + **G-pair-2** 종료 — G 잔여 (G-pair-2.5 poll 확장 + G-pair-3 client + G-pair-4 UI + conflict + offline + entitlement)) |
