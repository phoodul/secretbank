...
use secretbank_core::{Project, ProjectId, ProjectInput, ProjectPatch};
...
impl From<secretbank_storage::sqlite::StorageError> for ProjectCommandError {
...
mod tests {
    ...
    async fn project_list_returns_empty_when_vault_locked() {
        ...
        let list: Vec<secretbank_core::Project> = if is_locked {
            vec![]
        } else {
