...
impl From<secretbank_storage::sqlite::StorageError> for KillSwitchError {
...
mod tests {
    ...
    async fn bulk_revoke_revokes_only_issuer_a_credentials() {
        ...
        let issuer_repo = secretbank_storage::sqlite::repositories::issuer::IssuerRepo::new(&pool);
    ...
    impl secretbank_storage::vault::VaultStorage for FailingFlushVault {
        async fn unlock(
            &mut self,
        ...
        async fn put_secret(
            &mut self,
            path: &str,
            value: secretbank_storage::vault::SecretBytes,
        ) -> Result<(), secretbank_storage::vault::VaultError> {
        ...
        async fn get_secret(
            &self,
            path: &str,
        ) -> Result<secretbank_storage::vault::SecretBytes, secretbank_storage::vault::VaultError>
        {
        ...
        async fn flush(&mut self) -> Result<(), secretbank_storage::vault::VaultError> {
            Err(secretbank_storage::vault::VaultError::Io(
